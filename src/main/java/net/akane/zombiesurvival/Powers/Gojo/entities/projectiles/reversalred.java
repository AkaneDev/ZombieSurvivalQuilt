...
public class reversalred extends ProjectileEntity {
	public reversalred(EntityType<? extends ProjectileEntity> entityType, World world) {
	...
	public static DefaultAttributeContainer.Builder createReversalRedAttributes() {
